...
replace github.com/syseleven/sys11dbaas-sdk v0.0.0-20251009071335-472d6b2d2b2b => gitlab.syseleven.de/saas/sys11dbaas-sdk v0.0.0-20260302075304-552cce67974a
