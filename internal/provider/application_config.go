...
func (v ScheduledBackupsValue) ToDBaaSSdkObject(ctx context.Context) (*apiv1.PostgreSQLBackupSchedule, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	return &apiv1.PostgreSQLBackupSchedule{
		Retention: retention,
		Schedule:  schedule,
	}, diags
}
...
func (v ScheduleValue) ToDBaaSSdkObject(ctx context.Context) (*apiv1.PostgreSQLBackupScheduleConfig, diag.Diagnostics) {
	...
	return &apiv1.PostgreSQLBackupScheduleConfig{
		Hour:   hour,
		Minute: minute,
	}, diag.Diagnostics{}
}
