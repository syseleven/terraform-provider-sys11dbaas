...
func (v MaintenanceWindowValueV2) ToDBaaSSdkObject(ctx context.Context) (*database.PostgreSQLMaintenance, diag.Diagnostics) {
	...
	return &database.PostgreSQLMaintenance{
		DayOfWeek:   dayOfWeek,
		StartHour:   startHour,
