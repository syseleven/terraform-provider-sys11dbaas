...
func (v ScheduledBackupsValueV2) ToDBaaSSdkObject(ctx context.Context) (*database.PostgreSQLBackupSchedule, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	return &database.PostgreSQLBackupSchedule{
		Retention: retention,
		Schedule:  schedule,
	}, diags
}
...
func (v ScheduleValueV2) ToDBaaSSdkObject(ctx context.Context) (*database.PostgreSQLBackupScheduleConfig, diag.Diagnostics) {
	...
	return &database.PostgreSQLBackupScheduleConfig{
		Hour:   hour,
		Minute: minute,
	}, diag.Diagnostics{}
}
