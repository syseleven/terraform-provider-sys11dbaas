...
func (r *DatabaseResourceV2) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var psqlDB database.PostgreSQLGetResponse
	var err error
	errCount := 0
	for {
...
func psqlCreateResponseToModelV2(ctx context.Context, db database.PostgreSQLGetResponse, plan DatabaseModelV2, targetState *DatabaseModelV2) diag.Diagnostics {
...
func psqlGetResponseToModelV2(ctx context.Context, db database.PostgreSQLGetResponse, targetState *DatabaseModelV2, previousState DatabaseModelV2) diag.Diagnostics {
