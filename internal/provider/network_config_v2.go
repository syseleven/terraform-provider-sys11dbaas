...
func (v PrivateNetworkingValueV2) ToDBaaSSdkResponse(ctx context.Context) (*database.PostgreSQLPrivateNetworking, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	return &database.PostgreSQLPrivateNetworking{
...
func (v PrivateNetworkingValueV2) ToDBaaSSdkRequest(ctx context.Context) (*database.PostgreSQLPrivateNetworking, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v PublicNetworkingValueV2) ToDBaaSSdkResponse(ctx context.Context) (*database.PostgreSQLPublicNetworking, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	return &database.PostgreSQLPublicNetworking{
		Enabled:      v.Enabled.ValueBoolPointer(),
		Hostname:     v.Hostname.ValueStringPointer(),
		IpAddress:    v.IPAddress.ValueStringPointer(),
		AllowedCidrs: &ipList,
...
func (v PublicNetworkingValueV2) ToDBaaSSdkRequest(ctx context.Context) (*database.PostgreSQLPublicNetworking, diag.Diagnostics) {
	var diags diag.Diagnostics
